...
🌐 **Web Demo:** https://huggingface.co/spaces/siucapditbu/engineering-drawing-demo  
...
### Hướng cải thiện
- Ensemble 3 models (X-101 + R-101 + RetinaNet) với WBF — đã implement trong `v4_ensemble/`
- Fine-tune NMS threshold per-class
- Augment thêm: rotation ±5°, elastic distortion cho bản vẽ kỹ thuật
- Thử RT-DETR hoặc DINO với backbone lớn hơn
